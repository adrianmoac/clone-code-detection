...
id17=id7()
id49=[[] for id50 in id51(id17)]
id52=[-1]*id17

for id50 in id51(id17-1):
    id23,id24=id10()
    id49[id23-1].id53(id24-1)
    id49[id24-1].id53(id23-1)

def id54(id50,id55):
    id52[id50]=id55
    for id56 in id49[id50]:
        if id52[id56]==-1:
            id54(id56,id55+1)
    return
...
def id57(id50):
    ...
    id59=1
    for id56 in id49[id50]:
        if id52[id56]>id52[id50]:
            id58*=id57(id56)
            for id60 in id49[id56]:
                if id52[id60]>id52[id56]:
                   id59*=id57(id60)
    return id58+id59
