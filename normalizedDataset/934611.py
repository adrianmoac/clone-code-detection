...
@id39
def id46(id47):
    id48=[(id47>>(id17-id49-1))&1 for id49 in id50(id17)]
    if id51(id48)==1: return 1
    id11=0
    for id7 in id50(id17):
        if (id48[id7]==1) and id52([((id48[id53]==0) or (id53 not in id54[id7])) for id53 in id50(id17)]):
            id11+=id46(id47-(1<<(id17-id7-1)))
    return id11

id17,id18=id10()
id29,id31=[0]*id18,[0]*id18
id54=[[]for id7 in id50(id17)]
for id7 in id50(id18):
    id29[id7],id31[id7]=id10()
    id54[id29[id7]-1].id55(id31[id7]-1)
print id46((1<<id17)-1)
