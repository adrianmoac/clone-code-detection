...
@id39
def id49(id7,id24,id25):
    if id7<0:
        return 0
    elif id24>id7+1:
        return 0
    elif id24==1:
        return id29[0:id7+1].id50(id25)
    else:
        return id49(id7-1,id24,id25)+id49(id7-1,id24-1,id25-id29[id7])
        
for id51 in id52(id17):
    id48+=id49(id17-1,id51+1,id23*(id51+1))
