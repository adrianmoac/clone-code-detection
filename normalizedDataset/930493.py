...
id48=[0]*id17
id23=[0]*id17
for id49 in id50(id17):
    id48[id49],id23[id49]=id10()

id51,id52=1,1
for id49 in id50(id17):
    if id48[id49]>=id51 and id23[id49]>=id52:
        id51,id52=id48[id49],id23[id49]
    else:
        id53=id54(id51/id48[id49]+id8(id51%id48[id49]!=0),id52/id23[id49]+id8(id52%id23[id49]!=0))
        id51,id52=id48[id49]*id53,id23[id49]*id53
