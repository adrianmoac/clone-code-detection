...
id46,id47,id48=id10()
id49,id50,id51,id52=id10()

def id53(id29,id31,id54,id55):
    return (id54-id29)**2+(id55-id31)**2

#red
if id49<=id46-id48 and id46+id48<=id51 and id50<=id47-id48 and id47+id48<=id52:
    print "NO"
else:
    print "YES"

#blue
if id53(id46,id47,id49,id50)<=id48*id48 and id53(id46,id47,id49,id52)<=id48*id48 and id53(id46,id47,id51,id50)<=id48*id48 and id53(id46,id47,id51,id52)<=id48*id48:
    print "NO"
else:
    print "YES"