...
def id48(id24,id17):
    if id17<id24:
        ...
        return id48(id24,id8(id17/id24))+(id17%id24)
...
if id17==id11:
    ...
    for id49 in id50(2,id8(id2.id51(id17))+1):
        if (id17-id11)%(id49-1)==0:
            if id48(id49,id17)==id11:
                print id49
                break
    else:
        for id49 in id52(id50(1,id8(id2.id51(id17))+1)):
            if (id17-id11)%id49==0:
                if id48((id17-id11)/id49+1,id17)==id11:
                    print (id17-id11)/id49+1
                    break
        else:
            print-1