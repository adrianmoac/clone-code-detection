...
def id52():
    ...
    return id16(map(id54,id53.split(" ")))

if id55=="__main__":
    id34,id56=id52()
    id57=id12()

    for id36 in id37(10**6):
        try:
            id58=id52()
            if not id58:
                break
        ...
        id57.id14((id58[0],id58[1]),1)
    id59=id57.id40(id31=1)
    #print(res)
    if id34 in id59 and id59[id34]<=2:
        if id59[id34]==1:
            if id15(id60(id57.id13[1]).id61(id57.id13[id34]))>0:
                print("POSSIBLE")
            else:
                print("IMPOSSIBLE")
        else:
