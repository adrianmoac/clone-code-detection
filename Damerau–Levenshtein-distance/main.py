...
from ast import parse, NodeTransformer, copy_location, Name, FunctionDef, Expr, Constant
import astunparse
import editdistance
...
class NormFunctions(NodeTransformer):
    ...
    def visit_FunctionDef(self, node):
        ...
        if isinstance(new_func.body[0], Expr) and isinstance(new_func.body[0].value, Constant):
            del new_func.body[0]
...
# https://github.com/jncraton/pyastsim